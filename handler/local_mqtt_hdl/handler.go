...
func (h *Handler) HandleSubscriptions() {
	util.Logger.Infof(model.SubscribeString, logPrefix, topic.LocalDeviceEventSub)
	...
	util.Logger.Infof(model.SubscribeString, logPrefix, topic.LocalDeviceCmdResponseSub)
	...
	util.Logger.Infof(model.SubscribeString, logPrefix, topic.LocalProcessesStateSub)
	...
	util.Logger.Infof(model.SubscribeString, logPrefix, topic.LocalDeviceConnectorErrSub)
	...
	util.Logger.Infof(model.SubscribeString, logPrefix, topic.LocalDeviceErrSub)
	...
	util.Logger.Infof(model.SubscribeString, logPrefix, topic.LocalDeviceCmdErrSub)
